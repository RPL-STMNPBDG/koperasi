...
<table align="center" class="content-table">
    ...
    ?>
        ...
        <tr>
            ...
            <td> <?php echo $tampildata['pinjaman']?></td>
            <td align="center">
                <a href="../admin/index.php?page=inputpinjam&username=<?php echo $tampildata['username'];?>">Pinjam</a>
                |
                <a href="../admin/index.php?page=inputbayar&username=<?php echo $tampildata['username'];?>">Bayar</a>
            </td>
        </tr>
