...
<h3 class="header-fitur">
    <center>Edit Data Member Koperasi</center>
</h3>
    <form action="halaman/member/memberubah_aksi.php" method="post" name="formubah" enctype="multipart/form-data">
        <table class="table-form">
            <tr>
                <td><input type="button" value="Batalkan" onclick=location.href="index.php?page=member" class="button"></td>
                <td></td>
            ...
            <tr>
                ...
                <td><input type="radio" name="jenis_kelamin" value="<?php echo $tampildata['jenis_kelamin'] ?>" checked> Laki-Laki
                <input type="radio" name="jenis_kelamin" value="<?php echo $tampildata['jenis_kelamin'] ?>" checked> Perempuan</td>
            </tr>

            <tr>
                    <td class="form-header">Foto Profil</td>
                    <td>
                        <div class="img-wrapper">
                        <img src="<?php echo 'halaman/member/gambar/' . $tampildata['profil']; ?>" height="150px">
                        </div>
                        <input type="file" name="foto" class="files">
                        <input type="hidden" name="fotolama" value="<?php echo $tampildata['profil'] ?>">
                    </td>
                </tr>
            <tr>
            ...
            <tr>
                <td></td>
                <td><input type="submit" name="tombolubah" value="Ubah" onclick="return confirm('Apa Anda yakin akan mengubah data member?')" class="button">
            </tr>
        </table>
    </form>
